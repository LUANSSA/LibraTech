...
class Periodicos(models.Model):
    ...
    local = models.CharField("Local", max_length=200, null=True, blank=False)
    assunto = models.CharField("Assunto", max_length=300, null=True, blank=True)
    chamada = models.CharField("Chamada", max_length=300, null=True, blank=False)
    num_tombamento = models.CharField("Nº de Tombamento", max_length=300, null=True, blank=False)
    area_acervo = models.CharField("Área do Acervo", max_length=300, null=True, blank=False)
